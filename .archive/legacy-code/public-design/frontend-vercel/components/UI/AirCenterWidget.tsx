  ...
  return (
    <div className="bg-white rounded-3xl p-6 border border-sierra-navy/10 shadow-xl max-w-sm w-full">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="text-sierra-navy/40 hover:text-sierra-estates transition-colors">
          <Settings className="w-5 h-5" />
        </button>
      </div>
      
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-sierra-ivory p-4 rounded-2xl flex flex-col items-start border border-sierra-navy/5 hover:border-sierra-estates/30 transition-colors">
          <Activity className="w-6 h-6 text-sierra-estates mb-3" />
