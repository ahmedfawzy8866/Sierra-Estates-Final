    ...
    <div ref={containerRef} className="min-h-screen bg-ivory-100 text-navy-300">
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-navy-300/80 backdrop-blur-md border-b border-sierra-estates-500/20'
            : 'bg-transparent'
        }`}
      >
        <div className="max-w-7xl mx-auto px-safe py-4 flex justify-between items-center">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-sm text-sierra-estates-500 font-sans tracking-widest">REALTY</span>
          </div>

          {/* AirCenter Infrastructure Tracker */}
          <div className="flex items-center gap-3 bg-navy-300/20 backdrop-blur px-4 py-2 rounded-full border border-sierra-estates-500/30 font-mono text-xs text-sierra-estates-500">
          ...
          <div className="hidden md:flex gap-8">
            <button className="text-navy-300 hover:text-sierra-estates-500 transition-colors text-sm uppercase tracking-widest">
              Properties
            </button>
            <button className="text-navy-300 hover:text-sierra-estates-500 transition-colors text-sm uppercase tracking-widest">
              Intelligence
      ...
      <section className="relative h-screen bg-gradient-to-b from-navy-300 via-navy-200 to-ivory-100 pt-20 overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-sierra-estates-500 rounded-full blur-3xl" />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-safe h-full flex flex-col justify-center">
          <div className="animate-fade-in">
            <p className="text-sierra-estates-500 font-sans text-sm uppercase tracking-widest mb-6">
              Beyond Brokerage
            </p>
            ...
            >
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-5xl font-serif text-sierra-estates-500">98%</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-card p-6 max-h-96 overflow-y-auto">
              ...
              <div className="space-y-3">
                {properties.slice(0, 10).map((prop) => (
                  <div
                    key={prop.id}
                    className="p-4 bg-ivory-100 rounded-lg border-l-4 border-sierra-estates-500 hover:bg-ivory-200 transition-colors cursor-pointer"
                  >
            ...
            <div className="lg:col-span-2 bg-white rounded-xl shadow-card p-6 relative h-96 overflow-hidden">
              ...
              <div className="relative w-full h-full bg-gradient-subtle rounded-lg overflow-hidden">
                ...
                {properties.slice(0, 8).map((prop, idx) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-sierra-estates-500 rounded-full opacity-30 animate-pulse" />
                    <div className="relative z-10 bg-sierra-estates-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-sans text-xs font-bold group-hover:scale-150 transition-transform">
      ...
      <footer className="bg-navy-300 text-ivory-100 py-12">
        <div className="max-w-7xl mx-auto px-safe text-center">
          ...
          <div className="flex justify-center gap-6 text-xs uppercase tracking-widest">
            <a href="#" className="hover:text-sierra-estates-500 transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="hover:text-sierra-estates-500 transition-colors">
              Terms of Service
