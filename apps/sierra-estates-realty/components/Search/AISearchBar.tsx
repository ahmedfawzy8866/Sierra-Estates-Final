...
const PLACEHOLDERS = {
  en: [
    '3 bedroom apartment for rent in New Cairo under 50k EGP',
    'furnished studio Tagamoa monthly 20k',
    'villa for sale Sheikh Zayed with pool',
    'penthouse New Capital ROI 8%',
  ],
  ar: [
    'شقة 3 غرف للإيجار في التجمع الخامس تحت ٥٠ ألف',
    'استوديو مفروش التجمع شهري ٢٠ ألف',
    'فيلا للبيع الشيخ زايد بمسبح',
    'بنتهاوس العاصمة الإدارية عائد ٨٪',
  ],
};
...
const STRINGS = {
  ...
  ar: {
    ...
    sale: 'بيع',
    perMonth: '/شهر',
    noResults: 'لا توجد نتائج. جرّب بحثاً مختلفاً.',
    error: 'فشل البحث. حاول مرة أخرى.',
    extractedWith: 'استُخلص بـ',
    ai: 'الذكاء الاصطناعي',
    regex: 'قواعد أساسية',
    beds: 'غرف',
    baths: 'حمامات',
