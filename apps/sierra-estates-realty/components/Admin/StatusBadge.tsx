...
const PRESETS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  // Owner negotiation lifecycle (lib/models/schema.ts OwnerNegotiationStatus)
  contacted:       { bg: 'bg-amber-50',   text: 'text-amber-700',  border: 'border-amber-200' },
  negotiating:     { bg: 'bg-blue-50',    text: 'text-blue-600',   border: 'border-blue-200'  },
  agreed:          { bg: 'bg-purple-50',  text: 'text-purple-600', border: 'border-purple-200'},
  completed:       { bg: 'bg-emerald-50', text: 'text-emerald-700',border: 'border-emerald-200'},
  rejected:        { bg: 'bg-red-50',     text: 'text-red-600',    border: 'border-red-200'   },
  stale:           { bg: 'bg-gray-50',    text: 'text-gray-500',   border: 'border-gray-200'  },
};
