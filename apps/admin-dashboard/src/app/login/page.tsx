      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            <h1 className="text-white text-2xl font-bold tracking-tight uppercase mb-1 font-display">
              Sierra Estates
            </h1>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-4 bg-[#C9A84C] text-[#0A1628] rounded-lg
