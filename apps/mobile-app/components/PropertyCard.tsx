...
const styles = StyleSheet.create({
  ...
  offPlanPillText: { fontSize: 10, fontWeight: "700" },
  ...
  favBtn: { width: 34, height: 34, borderRadius: 17, alignItems: "center", justifyContent: "center" },
  featuredTag: { position: "absolute", bottom: 12, left: 12, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 4 },
  featuredText: { fontSize: 9, fontWeight: "800", letterSpacing: 1 },
  ...
  tourHintText: { fontSize: 10, fontWeight: "600" },
  content: { padding: 14 },
  ...
  yieldText: { fontSize: 11, fontWeight: "700" },
  ...
  offPlanText: { fontSize: 9, fontWeight: "700" },
  hContent: { flex: 1, padding: 12 },
  hPrice: { fontSize: 16, fontWeight: "800", marginBottom: 2 },
  hTitle: { fontSize: 13, fontWeight: "600", marginBottom: 2 },
  hLocation: { fontSize: 11, marginBottom: 6 },
