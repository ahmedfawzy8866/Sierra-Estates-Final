...
const PREVIEWS = [
  {
    ...
    title: 'Landing v1',
    label: 'First Landing',
    desc: 'The inaugural Sierra Blu landing page. Clean foundations, establishing the brand palette.',
    tag: 'Origin',
  ...
  },
  {
    ...
    desc: 'Sierra Blu Property Portal — early iteration with map integration and listing grid.',
    tag: 'Portal',
